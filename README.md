...
🚀 A complete guide to deploying a Flask application on Minikube, setting up Prometheus for metrics collection, and visualizing data on Grafana. This step-by-step project taught me how work done in production level and packed with practical instructions for a seamless hands-on experience. In this project i don't use high ML level project and do monitioring on this because of size of my ram , instead i use small  application for experience both prometheus-grafana- minikube through this project. 
...
## **Table of Contents**  
- [Prometheus-Grafana-Minikube-Project](#prometheus-grafana-minikube-project)
- [**Flask Application with Metrics**](#flask-application-with-metrics)
  - [**Project Overview**](#project-overview)
  - [**Table of Contents**](#table-of-contents)
  - [**Getting Started with Flask App**](#getting-started-with-flask-app)
  - [**Deploying Flask App on Minikube**](#deploying-flask-app-on-minikube)
  - [**Setting Up Prometheus**](#setting-up-prometheus)
  - [**Configuring Prometheus to Scrape Flask Metrics**](#configuring-prometheus-to-scrape-flask-metrics)
  - [**Installing Grafana**](#installing-grafana)
  - [**Visualizing Metrics with Grafana Dashboards**](#visualizing-metrics-with-grafana-dashboards)
